<template>
  <div>
    ...
    <div class="clearfix ">
      <Button type="primary" shape="circle" icon="plus-round" @click="adddepartment(1)">添加人员</Button>
    </div>
    ...
    return {
      ...
      columns7: [
        ...
        },
        {
          ...
          align: 'center',
          render: (h, params) => {
            return h('span',params.row.userState == 0? '停用' : '启用')
          }
        },
        {
          title: '操作',
            ...
            return h('div', [
                ...
                'Button',
                {
                  ...
                  on: {
                    click: () => {
                      ...
                      this.editecho (params.row.userCode,params.row.userName)
                    }
                  }
                },
                '编辑'
              ...
              h(
                'Button',
                {
                  ...
                  on: {
                    click: () => {
                      this.deleteout (params.row.userCode,params.row.seatCode)                     
                    }
                  }
                },
                '删除'
  ...
  methods: {
    ...
    addpersonnel () {      
        ...
        if (this.credittitle == '添加部门人员') {
            ...
            url = '/sale/saleSeat/updateSaleSeatInfo'
        }       
    ...
    editecho (code,name) {
        ...
        this.http.post(BASE_URL + '/sale/saleSeat/getSaleSeatInfo',list)
        .then((resp) => {
        if (resp.code == 'success') {
            this.userCode = code
            this.seatCode = resp.data.seatCode
            this.departmentCode = resp.data.departmentCode
            ...
            this.formValidate.seatNo = resp.data.seatNo
