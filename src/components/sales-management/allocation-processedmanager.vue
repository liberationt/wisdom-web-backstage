...
<div>
  <div class="navigation">
    ...
    <Modal v-model="modal2" class-name="vertical-center-modal" :mask-closable="false">
          ...
          <div slot="footer" >
            <Button type="default"  @click="modalclose()">关闭</Button>
  ...
  data() {
    return {
      ...
      ruleValidate: {
        ...
        standbyDesc: [
          { required: true, message: "请填写待办备注", trigger: "blur" }
        ]
      },
      dialRecordCode: "",
      loanOfficerCode: "",
      ...
      columns1: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "span",
              params.row.loanRechargeStatus == "0" ? "否" : "是"
            );
          }
        },
        {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              "span",
              params.row.allotType == "0" ? "指定分配" : "自己邀请"
            );
          }
        },
        {
          ...
          render: (h, params) => {
            return h("div", [
              ...
              //     on: {
              //       click: () => {
              //         this.lastarticle.pageNum = (this.startRow-1)*this.endRow+params.index+1
  ...
  methods: {
    ...
    inquire() {
      ...
      let data = Object.assign({
        ...
        allotType:
          this.distributionstatus == "''" ? "" : this.distributionstatus, //分配类型
      ...
      this.http
        .post(BASE_URL + "/sale/saleLoanOfficerInfo/querySaleList", data)
        .then(data => {
    ...
    dialsub(name) {
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          console.log(datetimel,datetimell)
          ...
          let list = {
            agencyTime: this.formValidate.appointment == "" ? "": utils.formatDate(
              this.formValidate.appointment,
              "yyyy-MM-dd hh:mm:ss"
            ),
