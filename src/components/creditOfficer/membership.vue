...
<div style="min-width:1070px">
    <div class="navigation">
        <p>
        <span>管理首页&nbsp;>&nbsp;应用>&nbsp;抢单侠>&nbsp;充值活动管理>&nbsp;充值会员赠送抢单劵</span>
        </p>
      </div>
            ...
            <ul>
              ...
              <li  class="mt15">
                ...
                <li class="clearfix mt15 credit_recharge">
                      <span class="left lh32 displayib w180 tr">档位:</span>
                      <div class="left ">   
                      <div
      ...
      marketingusbmit () {
          ...
          for (let x in this.firstaddnormals[j]) {
            if (x == 'rechargeCount') {
              ...
              if (this.firstaddnormals[j][x]>999999) {
                this.$Modal.warning({
                  title: '提示',
                  content: '<p>档位请输入0-999999之间的正整数</p>'
                })
                this.loading3 = false
                return false
              }
        ...
        this.$Modal.confirm({
          ...
          onOk: () => {        
            ...
            let url = '/loan/rechargeActivity/save-rob-vip'    
      ...
      inquireabout () {
        ...
        .then((resp) => {
          if (resp.code == 'success') {
            ...
            for (let i = 0; i < resp.data.robVipConfig.list.length; i++) {
              resp.data.robVipConfig.list[i].ticketNo = resp.data.robVipConfig.list[i].list[0].ticketNo
            }
            this.firstaddnormals = resp.data.robVipConfig.list
          } else {
            this.$Message.warning(resp.message);                 
          }
        })
