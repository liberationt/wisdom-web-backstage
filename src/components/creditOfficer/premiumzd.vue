...
<div style="min-width:1070px">
    <div class="navigation">
        <p>
        <span>管理首页&nbsp;>&nbsp;应用>&nbsp;抢单侠>&nbsp;充值活动管理>&nbsp;充值赠送赞豆</span>
        </p>
      </div>
            ...
            <ul>
              ...
              <li class="clearfix mt15 credit_recharge">
                      ...
                      >
                        ...
                        <Input :disabled="auditing" type="text" v-model="item.giveCount" class="left mb5 ml10 inputnum"  style="width:150px">
                        <span slot="prepend">赠送</span>
                        <span slot="append" class="left">赞豆</span>
                        </Input>
                        <Input :disabled="auditing" type="text" v-model="item.days" class="left mb5  inputnum"  style="width:120px">
                ...
                <li class="clearfix mt15 credit_recharge">
                      ...
                      >
                        ...
                        <div class="left ml10" v-for="(res,i) in item.list">
                            <Input :disabled="auditing" type="text" v-model="res.giveCount" class="left mb5 inputnum"  style="width:180px">
                            <span slot="prepend" v-if="res.vipLevel==-1">普通用户送</span>
                            <span slot="prepend" v-else>会员V{{res.vipLevel}}送</span>
                            <span slot="append" class="left">赞豆</span>
                            </Input>
                            <Input :disabled="auditing" type="text" v-model="res.days"  class="left mb5  inputnum"  style="width:120px">
                            <span slot="append" class="left">天有效期</span>
                            </Input>
                        </div>
      ...
      marketingusbmit () {
        ...
        this.$Modal.confirm({
          ...
          onOk: () => {        
            ...
            let url = '/loan/rechargeActivity/save-zd'    
      ...
      inquireabout () {
        ...
        .then((resp) => {
          if (resp.code == 'success') {
            ...
            this.addnormals = resp.data.zdConfig.firstList
            this.firstaddnormals = resp.data.zdConfig.list
          } else {
            this.$Message.warning(resp.message);                 
          }
        })
