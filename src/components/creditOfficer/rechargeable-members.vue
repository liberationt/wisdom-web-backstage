...
<div style="min-width:1070px">
    <div class="navigation">
        <p>
        <span>管理首页&nbsp;>&nbsp;应用>&nbsp;抢单侠>&nbsp;充值活动管理>&nbsp;充值赠送会员</span>
        </p>
      </div>
            ...
            <ul>
              ...
              <li class="clearfix mt15 credit_recharge">
                      ...
                      >
                        ...
                        <Input :disabled="auditing" type="text" v-model="item.days" class="left mb5 ml10 inputnum"  style="width:150px">
                ...
                <li class="clearfix mt15 credit_recharge">
                      ...
                      >
                        ...
                        <div class="left ml10" v-for="(res,i) in item.list">
                            <Input :disabled="auditing" type="text" v-model="res.days" class="left mb5 inputnum"  style="width:180px">
      ...
      marketingusbmit () {
        ...
        this.$Modal.confirm({
          ...
          onOk: () => {        
            ...
            let url = '/loan/rechargeActivity/save-vip'    
      ...
      inquireabout () {
        ...
        .then((resp) => {
          if (resp.code == 'success') {
            ...
            this.addnormals = resp.data.vipConfig.firstList
            this.firstaddnormals = resp.data.vipConfig.list
          } else {
            this.$Message.warning(resp.message);                 
          }
        })
