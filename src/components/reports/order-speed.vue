<template>
    <div>
		<div class="navigation">
			<p>
				<span>管理首页&nbsp;>&nbsp;报表&nbsp;>&nbsp;抢单侠报表&nbsp;>&nbsp;订单消化速度</span>
			</p>
		</div>
	...
	methods:{
      ...
      if (date1 > date2) {
        ...
        pageNum: startRow,
			...
			this.http.post(BASE_URL + '/report/reportOrderDigest/queryPage', data)
      .then((resp) => {
      ...
      .catch(() => {
		...
		exports(){
			...
			this.loading2 = true;
			let httpUrl= BASE_URL+'/report/reportOrderDigest/export'
