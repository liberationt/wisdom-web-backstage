<template>
    <div>
		<div class="navigation">
			<p>
				<span>管理首页&nbsp;>&nbsp;报表&nbsp;>&nbsp;华赞报表&nbsp;>&nbsp;渠道转化率报表-信息流投放</span>
			</p>
		</div>
		<div class="clearfix contentcss">
				<ul class="querysty">
					...
					<li>
						<Input v-model="marketName" class="ml20" placeholder="请输入媒体名称" clearable style="width: 180px" />
					</li>
					<li>
		...
		<div id="application_table " class="contentcss mt10">
			<div id="application_table" class="mt15">
				<Table border :row-class-name="rowClassName" highlight-row :columns="columns7" :data="data6"></Table>
			</div>
			<div class="tr mt15">
...
export default {
	...
	methods:{
		...
		queryList(startRow){
			...
			this.http.post(BASE_URL+"/report/reportHuaZanChannel/queryHuaZanChannelReport",{
      ...
      formData.append("endTime", this.endTime == "" ? "" :untils.formatDate(this.endTime,'yyyy-MM-dd 23:59:59'));
			formData.append("channelParent", '2' );
			formData.append("channelName", this.marketName );
      untils.exporttable(BASE_URL+'/report/reportHuaZanChannel/exportHuaZanChannelReport', untils.getlocal("token"), formData, e => {
        this.loading2 = false;
      });
		},
		ifDate(){
